...
// OEM-shaped Network service: the saved places file is this file's and ui/NetworkPlaces.qml's, gio is
// theirs plus ui/PhoneMounts.qml's, which unmounts off this listing; Sidebar only renders their rows.
Item {
    id: root
