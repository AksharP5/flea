...
pub fn listed_line(n: usize, read_ms: f64, sort_ms: f64, dev: u64, path: &str, long: usize) -> String {
    format!(
        r#"{{"t":"listed","n":{},"read":{:.3},"sort":{:.3},"v":{},"path":"{}","long":{}}}"#,
        n, read_ms, sort_ms, dev, escape(path), long
    )
}
...
mod tests {
    ...
    fn emits_a_listed_line_naming_the_directory_it_listed() {
        let s = listed_line(100000, 26.4, 2.5, 56, "/home/gm", 31);
        assert_eq!(s, r#"{"t":"listed","n":100000,"read":26.400,"sort":2.500,"v":56,"path":"/home/gm","long":31}"#);
    }
