...
function run(check) {
    ...
    check("Menus and Places inventory has 34 actions", Menu.INVENTORY.length, 34)
    ...
    check("inventory storage ids are unique", Object.keys(Menu.INVENTORY.reduce(function (out, row) { out[row[0]] = true; return out }, {})).length, 34)
